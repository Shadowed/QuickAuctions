QuickAuctionsLocals = {
	...
	["/qa cancelall <group> - Cancels all active auctions, or cancels auctions in a group if you pass one"] = "/qa cancelall <group> - Cancels all active auctions, or cancels auctions in a group if you pass one",
	...
	["Cancelled %d of %d"] = "Cancelled %d of %d",
	...
	["Click an item to add it to this group, you cannot add an item that is already in another group."] = "Click an item to add it to this group, you cannot add an item that is already in another group.",
	...
	["Finished cancelling %d auctions"] = "Finished cancelling %d auctions",
	["Finished posting %d items"] = "Finished posting %d items",
	["Flask"] = "Flask",
	["Flasks"] = "Flasks",
	["Food"] = "Food",
	...
	["Mass cancelling posted items in the group %s"] = "Mass cancelling posted items in the group %s",
	...
	["Percentage of the buyout the bid will be set t, if the buyout is 100g and set you set this to 90%, then the buyout will be 90g."] = "Percentage of the buyout the bid will be set t, if the buyout is 100g and set you set this to 90%, then the buyout will be 90g.",
	["Perfect (.+)"] = "Perfect (.+)",
	...
	["Post time"] = "Post time",
	["Posting %s (%d/%d) bid %s, buyout %s"] = "Posting %s (%d/%d) bid %s, buyout %s",
	["Posting %s (%d/%d) bid %s, buyout %s (Buyout went below zero, undercut by 1 copper instead)"] = "Posting %s (%d/%d) bid %s, buyout %s (Buyout went below zero, undercut by 1 copper instead)",
	["Posting %s (%d/%d) bid %s, buyout %s (Forced to fallback cap, lowest price was too high)"] = "Posting %s (%d/%d) bid %s, buyout %s (Forced to fallback cap, lowest price was too high)",
	["Posting %s (%d/%d) bid %s, buyout %s (No other auctions up)"] = "Posting %s (%d/%d) bid %s, buyout %s (No other auctions up)",
	...
	["Retry %d of %d for %s"] = "Retry %d of %d for %s",
	...
	["Scanned page %d of %d for %s"] = "Scanned page %d of %d for %s",
	["Scanning %d items..."] = "Scanning %d items...",
	["Scanning %s"] = "Scanning %s",
	["Scanning page %d of %d for %s"] = "Scanning page %d of %d for %s",
	...
	["Skipped %s, need %d for a single post, have %d"] = "Skipped %s, need %d for a single post, have %d",
	["Skipped %s, posted %d of %d already"] = "Skipped %s, posted %d of %d already",
	["Slash commands"] = "Slash commands",
	["Smart cancelling"] = "Smart cancelling",
	["Smart undercutting"] = "Smart undercutting",
	["Starting an auction scan..."] = "Starting an auction scan...",
	...
	["Undercut on %s by %s, but %s placed a bid of %s so not cancelling"] = "Undercut on %s by %s, but %s placed a bid of %s so not cancelling",
	["Undercut on %s by %s, buyout %s, yours %s (per item)"] = "Undercut on %s by %s, buyout %s, yours %s (per item)",
	["Undercut on %s by %s, their buyout %s, yours %s (per item), threshold is %s not cancelling"] = "Undercut on %s by %s, their buyout %s, yours %s (per item), threshold is %s not cancelling",
