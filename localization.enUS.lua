QuickAuctionsLocals = {
	...
	["/qa time <12/24/48> <link/type/group> - Amount of hours to put auctions up for."] = "/qa time <12/24/48> <link/type/group> - Amount of hours to put auctions up for.",
	["/qa undercut <money> <link/type/roup> - How much to undercut people by."] = "/qa undercut <money> <link/type/roup> - How much to undercut people by.",
	["/qa cap <amount> <link/type/group> - Only allow <amount> of the same kind of auction to be up at the same time."] = "/qa cap <amount> <link/type/group> - Only allow <amount> of the same kind of auction to be up at the same time.",
	["/qa fallback <money> <link/type/group> - How much money to default to if nobody else has an auction up."] = "/qa fallback <money> <link/type/group> - How much money to default to if nobody else has an auction up.",
	["/qa threshold <money> <link/type/group> - Don't post any auctions that would go below this amount."] = "/qa threshold <money> <link/type/group> - Don't post any auctions that would go below this amount.",
