QuickAuctionsLocals = {
	...
	["Herb"] = "Herb",
	["Herbs"] = "Herbs",
	["Hide uncraftable"] = "Hide uncraftable",
	["Hides any items that you cannot craft (anything with an X next to it)."] = "Hides any items that you cannot craft (anything with an X next to it).",
	...
	["Show uncraftable"] = "Show uncraftable",
