...
QuickAuctions.L = {
	...
	["Undercutting auctions by %s until price goes below %s, unless there is greater than a |cfffed000%d%%|r price difference between lowest and second lowest in which case undercutting second lowest auction."] = "Undercutting auctions by %s until price goes below %s, unless there is greater than a |cfffed000%d%%|r price difference between lowest and second lowest in which case undercutting second lowest auction.",
