...
QuickAuctions.L = {
	...
	["Post time"] = "Post time",
	["Posting %s%s (%d) bid %s, buyout %s"] = "Posting %s%s (%d) bid %s, buyout %s",
	["Posting %s%s (%d) bid %s, buyout %s (Buyout went below zero, undercut by 1 copper instead)"] = "Posting %s%s (%d) bid %s, buyout %s (Buyout went below zero, undercut by 1 copper instead)",
	["Posting %s%s (%d) bid %s, buyout %s (Forced to fallback price, lowest price was too high)"] = "Posting %s%s (%d) bid %s, buyout %s (Forced to fallback price, lowest price was too high)",
	["Posting %s%s (%d) bid %s, buyout %s (Forced to fallback price, market below threshold)"] = "Posting %s%s (%d) bid %s, buyout %s (Forced to fallback price, market below threshold)",
	["Posting %s%s (%d) bid %s, buyout %s (Increased bid price due to going below thresold)"] = "Posting %s%s (%d) bid %s, buyout %s (Increased bid price due to going below thresold)",
	["Posting %s%s (%d) bid %s, buyout %s (Increased buyout price due to going below thresold)"] = "Posting %s%s (%d) bid %s, buyout %s (Increased buyout price due to going below thresold)",
	["Posting %s%s (%d) bid %s, buyout %s (No other auctions up)"] = "Posting %s%s (%d) bid %s, buyout %s (No other auctions up)",
	["Posting %s%s (%d) bid %s, buyout %s (Price difference too high, used second lowest price intead)"] = "Posting %s%s (%d) bid %s, buyout %s (Price difference too high, used second lowest price intead)",
	...
	["You are at the gold cap and cannot loot gold from the mailbox."] = "You are at the gold cap and cannot loot gold from the mailbox.",
