QuickAuctionsLocals = {
	...
	["Post time"] = "Post time",
	["Posted %s (%d/%d) bid %s, buyout %s"] = "Posted %s (%d/%d) bid %s, buyout %s",
	["Posted %s (%d/%d) bid %s, buyout %s (Buyout went below zero, undercut by 1 copper instead)"] = "Posted %s (%d/%d) bid %s, buyout %s (Buyout went below zero, undercut by 1 copper instead)",
	["Posted %s (%d/%d) bid %s, buyout %s (Forced to fallback cap, lowest price was too high)"] = "Posted %s (%d/%d) bid %s, buyout %s (Forced to fallback cap, lowest price was too high)",
	["Posted %s (%d/%d) bid %s, buyout %s (No other auctions up)"] = "Posted %s (%d/%d) bid %s, buyout %s (No other auctions up)",
