...
QuickAuctions.L = {
	...
	["Allows you to override the default auto fallback settings."] = "Allows you to override the default auto fallback settings.",
	...
	["Allows you to override the default price threshold settings."] = "Allows you to override the default price threshold settings.",
	...
	["Auto mail"] = "Auto mail",
	["Auto mail looter"] = "Auto mail looter",
	...
	["Automatically posts auctions at the fallback price if the lowest item in the auction house is below the threshold price."] = "Automatically posts auctions at the fallback price if the lowest item in the auction house is below the threshold price.",
	...
	["Disable cancelling"] = "Disable cancelling",
	["Disables automatically cancelling items if they are undercut and in this group."] = "Disables automatically cancelling items if they are undercut and in this group.",
	...
	["Enable super scan"] = "Enable super scan",
	...
	["How many seconds Quick Auctions should wait between looting mail."] = "How many seconds Quick Auctions should wait between looting mail.",
	...
	["Instead of mail opening interval being based off a static amount, it will use your latency. For example, if you have 150 MS latency it will loot an item every 0.175 seconds, if you have 20 MS latency it will loot an item every 0.035 seconds."] = "Instead of mail opening interval being based off a static amount, it will use your latency. For example, if you have 150 MS latency it will loot an item every 0.175 seconds, if you have 20 MS latency it will loot an item every 0.035 seconds.",
	["Interval off latency"] = "Interval off latency",
	...
	["Override price threshold after"] = "Override price threshold after",
	...
	["Perfect (.+)"] = "Perfect (.+)",
	["Play sound after cancel scan"] = "Play sound after cancel scan",
	...
	["Super scan will drastically speed up your auction posting, but you will lose the ability to use whitelist functions and it will undercut anyone except the character you are posting on."] = "Super scan will drastically speed up your auction posting, but you will lose the ability to use whitelist functions and it will undercut anyone except the character you are posting on.",
	["Super scanning will speed up your auction scanning, but it will no longer get accurate poster name data.\n\nWhitelist functions and matching your alts will no longer work if you enable this."] = "Super scanning will speed up your auction scanning, but it will no longer get accurate poster name data.\n\nWhitelist functions and matching your alts will no longer work if you enable this.",
	...
	["When Quick Auctions finishes a cancel scan it will play the ready check sound telling you that it needs your interacting.\n\nOf course, you need sound enabled for this to do anything."] = "When Quick Auctions finishes a cancel scan it will play the ready check sound telling you that it needs your interacting.\n\nOf course, you need sound enabled for this to do anything.",
	...
	["You can set the fallback settings to use for items that do not have one set specifically for their group, or per item.\n\nMoney values should be entered as \"#g#s#c\". For example, \"50g20s\" is entered as 50 gold, 20 silver.\n\nAll sliders can have their values entered manually, use the middle number below the slider bar."] = "You can set the fallback settings to use for items that do not have one set specifically for their group, or per item.\n\nMoney values should be entered as \"#g#s#c\". For example, \"50g20s\" is entered as 50 gold, 20 silver.\n\nAll sliders can have their values entered manually, use the middle number below the slider bar.",
	["You cannot use the mailing features with Postal enabled."] = "You cannot use the mailing features with Postal enabled.",
