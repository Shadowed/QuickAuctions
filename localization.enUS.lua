QuickAuctionsLocals = {
	...
	["/qa time <12/24/48> <link/type> - Amount of hours to put auctions up for, only works for the current sesson."] = "/qa time <12/24/48> <link/type> - Amount of hours to put auctions up for, only works for the current sesson.",
