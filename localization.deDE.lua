...
QuickAuctionsLocals = setmetatable({
	...
	["Allows you to override the default auto fallback settings."] = "\195\156bersteuert die Standardeinstellungen für automat. Fallback.",
	...
	["Override threshold"] = "Schwellenwert \195\188bersteuern",
