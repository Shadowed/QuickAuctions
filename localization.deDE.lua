...
QuickAuctions.L = setmetatable({
	...
	["Mass adds all items matching the below, entering \"Glyph of\" will mass add all items starting with \"Glyph of\" to this group."] = "F\195\188gt alle Gegenst\195\164nde hinzu, die den Kriterien unten entsprechen. \"Glyphe der\" wird alle Gegenst\195\164nde die mit \"Glyphe der\" beginnen zu dieser Gruppe hinzuf\195\188gen.",
	...
	["Ok"] = "Ok",
	["Once market goes below %s, auctions will be automatically posted at the fallback price of %s."] = "Sobald der Makt unter %s f\195\164llt, werden Auktionen automatisch zum Fallbackpreis von %s ins AH gesetzt.",
	...
	["Undercutting auctions by %s until price goes below %s, unless there is greater than a |cfffed000%.2f%%|r price difference between lowest and second lowest in which case undercutting second lowest auction."] = "Unterbiete Auktionen um %s bis der Preis unter %s f\195\164llt, ausser es gibt eine gr\195\182ssere Differenz als |cfffed000%.2f%%|r zwischen dem tiefsten und zweittiefsten Preis. In diesem Fall wird die zweittiefste Auktion unterboten.",
	...
	["Waiting..."] = "Warte...",
	["When no auctions are up, or the market price is above %s auctions will be posted at the fallback price of %s."] = "Wenn keine anderen Auktionen vorhanden sind oder der Marktpreis \195\188ber %s liegt, werden die Auktionen zum Fallbackpreis von %s ins AH gesetzt.",
