...
QuickAuctionsLocals = setmetatable({
	...
	["Allows you to override the default auto fallback settings."] = "\195\156bersteuert die Standardeinstellungen f\195\188r automat. Fallback.",
	...
	["Allows you to override the default price threshold settings."] = "\195\156bersteuert die Standardeinstellungen f\195\188r die max. Preisdifferenz.",
	...
	["Automatically posts auctions at the fallback price if the lowest item in the auction house is below the threshold price."] = "Auktionen werden automatisch zum Fallback-Preis ins AH gesetzt, wenn der niedrigste Preis unter dem Schwellenwert liegt.",
	...
	["Enable super scan"] = "Super-Scan aktivieren",
	...
	["Override price threshold after"] = "Max. Preisdifferenz \195\188bersteuern",
	...
	["Perfect (.+)"] = "Perfekt(.+)",
	["Play sound after cancel scan"] = "Spiele einen Sound wenn das Scannen abgebrochen wurde",
	...
	["Super scan will drastically speed up your auction posting, but you will lose the ability to use whitelist functions and it will undercut anyone except the character you are posting on."] = "Super Scan wird das Erstellen von Auktionen drastisch beschleunigen, aber die Funktion der weissen Liste verlieren und jeden unterbieten mit Ausnahme Deines aktuellen Charakters.",
	...
	["When Quick Auctions finishes a cancel scan it will play the ready check sound telling you that it needs your interacting.\n\nOf course, you need sound enabled for this to do anything."] = "Sobald Quick Auctions einen Abbruch-Scan beendet hat, wird der Klang des Bereitschaftstests abgespielt, da Dein Eingreifen notwendig ist.\n\nNat\195\188rlich muss Dein Sound daf\195\188r aktiviert sein.",
	...
	["You can set the fallback settings to use for items that do not have one set specifically for their group, or per item.\n\nMoney values should be entered as \"#g#s#c\". For example, \"50g20s\" is entered as 50 gold, 20 silver.\n\nAll sliders can have their values entered manually, use the middle number below the slider bar."] = "Du kannst die Fallback-Einstellungen setzen f\195\188r Gegenst\195\164nde ohne spezielle Einstellungen auf ihren Gruppen.\n\nGeldwerte m\195\188ssen als \"#g#s#c\" eingegeben werden. Zum Beispiel \"50g20s\" f\195\188r 50 Gold und 20 Silber.\n\nBei allen Schiebereglern kann ein Wert auch direkt eingegeben werden, benutze dazu die mittlere Zahl unter dem Schieberegler.",
